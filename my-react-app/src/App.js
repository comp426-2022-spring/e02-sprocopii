...
// 2. This line is where you add the points all together. Add your other variable references here. Make sure that they match what is above and what is below in the HTML form
    let sum = parseInt(currentA00) + parseInt(currentA01) + parseInt(currentA02) + parseInt(currentA03) + parseInt(currentA04) + parseInt(currentA05) + parseInt(currentMidterm) + parseInt(currentFinal) + parseInt(currentE01) + parseInt(currentE02) + parseInt(currentCommits);
    setCurrentSum(sum);
  }
  ...
  return (
    <div className="App">
      ...
      <form>
            ...
            <input type="text" id="a02" placeholder="a02 Functions and Models" /><br/><br/>
            ...
            <input type="text" id="a05" placeholder="a05 Human Inteface" /><br/><br/>
